...
$echo .= '<form action="http://localhost/wp/yeni-dokuman" method="get">
...
<script>
$("#left").hide();
var step = "<?php echo get_option('nm_file_file_limit'); ?>";
...
add_action('wp_enqueue_scripts', 'load_fileuploader_script2');

function load_fileuploader_script2() {
